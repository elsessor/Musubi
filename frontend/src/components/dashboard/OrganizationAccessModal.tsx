...
export function OrganizationAccessModal({ role, user, onClose, onComplete }: Props) {
  ...
  useEffect(() => {
    if (profile?.organizationId && mode === "create") setMode("join");
  }, [profile, mode]);
